...
let checkTheme = document.querySelector('#darkTheme')

checkTheme.addEventListener('click',()=>{
    if(checkTheme.checked){
        document.querySelector('#linkAnchor').nextElementSibling.setAttribute("href","./assets/css/darkTheme.css")
    } else {
        document.querySelector('#linkAnchor').nextElementSibling.setAttribute("href","")
    }
})